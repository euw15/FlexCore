 ...
 */
package com.flexdesktop.user.Error;
...
public class InfError {
    ...
    static public void showInformation(Component comp, String msg) {
        ...
        ImageIcon icon = new ImageIcon(InfError.class.getResource("/com/flexdesktop/user/images/info.png"));
    ...
    static public int showQuestion(Component comp, String msg) {
        ...
        ImageIcon icon = new ImageIcon(InfError.class.getResource("/com/flexdesktop/user/images/question.png"));
    ...
    static public void showMessage(Component comp, String msg) {
        ImageIcon icon = new ImageIcon(InfError.class.getResource("/com/flexdesktop/user/images/idea.png"));
